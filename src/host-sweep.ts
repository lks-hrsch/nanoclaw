...
// Set to 2 hours to allow long-running tool chains (e.g. batching many GitHub
// API calls) to complete without being prematurely killed.
export const ABSOLUTE_CEILING_MS = 2 * 60 * 60 * 1000;
